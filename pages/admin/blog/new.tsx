    ...
    <div className="pt-24 pb-20 bg-slate-50 min-h-screen">
      <div className="max-w-3xl mx-auto bg-white shadow-2xl p-10 md:p-14 border-t-8 border-black">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold serif">New Blog Post</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            ...
            <textarea name="excerpt" rows={3} value={form.excerpt} onChange={handleChange} className="w-full bg-slate-50 border-b-2 border-slate-200 py-3 outline-none focus:border-black font-bold" required />
          </div>
          <div>
            ...
            <p className="text-[10px] text-slate-400 mt-2 uppercase tracking-widest">Line breaks are preserved.</p>
          </div>
